...
public class FormularioClientes 
{
	...
	{		
		...
		panelPrincipal.add(objBotonesFlechas.panelBotonesFlechas);
		...
		codigoCliente = new JLabel("Codigo del cliente: ");
		...
		provincia = new JLabel("Municipio: ");
	...
	public void comprobarClientePrimero()
	{
		...
		else
		{
			...
			{
				JOptionPane.showMessageDialog(null, "Aviso, ya esta en el primer cliente");
			}
		}		
	}
	...
	public void comprobarClienteAnterior()
	{
		...
		else
		{
			...
			{
				JOptionPane.showMessageDialog(null, "Aviso, ya est� en el primer cliente");
			}	
		}			
	}
	...
	public void comprobarClienteSiguiente()
	{
		...
		else
		{
			...
			{
				JOptionPane.showMessageDialog(null, "Aviso, ya esta en el ultimo cliente");
			}	
		}			
	}
