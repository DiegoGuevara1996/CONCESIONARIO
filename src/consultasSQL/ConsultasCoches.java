...
public class ConsultasCoches 
{
	...
	public void anadirCoches(Coches objCoches) 
	{
		...
		{
			JOptionPane.showMessageDialog(null, "Error, ya existe un coche con ese codigo ");
		}		
	}
	...
	//BORRAR COCHES
	public void borrarCoches(String borrar2matricula)
	{
		String borrar = "DELETE FROM coches WHERE matricula =" +borrar2matricula;
		try
		{
