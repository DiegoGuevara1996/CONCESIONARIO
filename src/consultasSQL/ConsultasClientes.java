...
public class ConsultasClientes 
{
	...
	public void anadirClientes(Clientes objClientes) 
	{
		...
		{
			JOptionPane.showMessageDialog(null, "Error, ya existe un cliente con ese c�digo");
		}		
	}
	...
	//BORRAR CLIENTES
	public void borrarCliente(int borrar1 )
	{
		String borrar = "DELETE FROM clientes WHERE codCliente  = "+borrar1;
		try
		{
